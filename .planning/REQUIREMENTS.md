...
- [ ] **CSS-02**: Plain CSS-fil ersätter Tailwind — innehåller CSS reset (ersätter Tailwind preflight) och all befintlig styling
- [ ] **CSS-03**: CSS custom properties definierar färgpalett och typsnitt (ersätter `tailwind.config.cjs` theme-värden)
